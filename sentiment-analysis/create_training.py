...
def initialize_data():
    ...
    rel_data_path = "data/labeled/cleaned/combined/data_sample_relevance.csv"
...
def write_to(labeled_data):
    ...
    rel_data_path = "data/labeled/cleaned/combined/data_relevance_training.csv"
    script_dir = os.path.dirname(__file__)
    abs_cleaned_path = os.path.join(script_dir, rel_data_path).replace("sentiment-analysis\\", "")
...
if __name__ == "__main__":
    ...
    # Get Labeled, Referenced, and Translated Data.
    labeled_data = initialize_data()

    # Write Labeled Data to a Training File.
    write_to(labeled_data)